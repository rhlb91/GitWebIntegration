...
/**
 * Reusable coarse date-based object cache. The date precision is in milliseconds and in fast,
 * concurrent systems this cache is too simplistic. However, for the cases where its being used in
 * this project this cache technique is just fine.
 *
 *
 */
