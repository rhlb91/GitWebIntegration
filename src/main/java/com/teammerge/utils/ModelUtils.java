...
public class ModelUtils {
   ...
   * @return true, if the name starts with the active user repository project prefix. False,
   *         otherwise.
   */
  public static boolean isPersonalRepository(String name) {
    if (name.startsWith(userRepoPrefix))
      return true;
    return false;
  }
  ...
  public static boolean isUsersPersonalRepository(String username, String name) {
    if (name.equalsIgnoreCase(getPersonalPath(username)))
      return true;
    return false;
  }
