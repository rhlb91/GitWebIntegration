...
public interface XssFilter {
  ...
  /**
   * Returns a filtered version of the input value that contains no html elements.
   *
   * @param input
  ...
  /**
   * Returns a filtered version of the input that contains structural html elements.
   *
   * @param input
