...
public class StringUtils {
  ...
  /**
   * Prepare text for html presentation. Replace sensitive characters with html entities.
   *
   * @param inStr
   * @param changeSpace
  ...
  /**
   * Flatten the list of strings into a single string with the specified separator.
   *
   * @param values
   * @param separator
  ...
  /**
   * Returns a string trimmed to a maximum length with trailing ellipses. If the string length is
   * shorter than the max, the original string is returned.
   *
   * @param value
   * @param max
  ...
  /**
   * Left pad a string with the specified character, if the string length is less than the specified
   * length.
   *
   * @param input
   * @param length
  ...
  /**
   * Right pad a string with the specified character, if the string length is less then the
   * specified length.
   *
   * @param input
   * @param length
  ...
  /**
   * Returns the root path of the specified path. Returns a blank string if there is no root path.
   *
   * @param path
  ...
  /**
   * Returns the path remainder after subtracting the basePath from the fullPath.
   *
   * @param basePath
   * @param fullPath
  ...
  /**
   * Validates that a name is composed of letters, digits, or limited other characters.
   *
   * @param name
  ...
  /**
   * Simple fuzzy string comparison. This is a case-insensitive check. A single wildcard * value is
   * supported.
   *
   * @param value
   * @param pattern
  ...
  /**
   * Decodes a string by trying several charsets until one does not throw a coding exception. Last
   * resort is to interpret as UTF-8 with illegal character substitution.
   *
   * @param content
  ...
  /**
   * Attempt to extract a repository name from a given url using regular expressions. If no match is
   * made, then return whatever trails after the final / character.
   *
   * @param regexUrls
  ...
  /**
   * Returns the first path element of a path string. If no path separator is found in the path, an
  ...
  /**
   * Removes new line and carriage return chars from a string. If input value is null an empty
   * string is returned.
   *
   * @param input
