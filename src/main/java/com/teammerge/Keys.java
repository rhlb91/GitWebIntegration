...
/*
 * This class is auto-generated from a properties file. Do not version control!
 */
public final class Keys {
  ...
  public static final class git {
    ...
    public static final String checkReferencedObjectsAreReachable =
                                                                      "git.checkReferencedObjectsAreReachable";
    ...
    public static final String defaultAuthorizationControl        =
                                                                      "git.defaultAuthorizationControl";

    public static final String defaultGarbageCollectionPeriod     =
                                                                      "git.defaultGarbageCollectionPeriod";

    public static final String defaultGarbageCollectionThreshold  =
                                                                      "git.defaultGarbageCollectionThreshold";

    public static final String defaultIncrementalPushTagPrefix    =
                                                                      "git.defaultIncrementalPushTagPrefix";
    ...
    public static final String enforceCertificateValidity         =
                                                                      "git.enforceCertificateValidity";
    ...
    public static final String onlyAccessBareRepositories         =
                                                                      "git.onlyAccessBareRepositories";
    ...
    public static final String searchRepositoriesSubfolders       =
                                                                      "git.searchRepositoriesSubfolders";
    ...
    public static final String sshKrb5ServicePrincipalName        =
  ...
  public static final class realm {
    ...
    public static final class windows {
      ...
      public static final String permitBuiltInAdministrators =
                                                                 "realm.windows.permitBuiltInAdministrators";
  ...
  public static final class tickets {
    ...
    public static final String closeOnPushCommitMessageRegex =
                                                                 "tickets.closeOnPushCommitMessageRegex";

    public static final String indexFolder                   = "tickets.indexFolder";

    public static final String linkOnPushCommitMessageRegex  =
                                                                 "tickets.linkOnPushCommitMessageRegex";
  ...
  public static final class web {
    ...
    public static final String activityDurationChoices               =
                                                                         "web.activityDurationChoices";

    public static final String activityDurationMaximum               =
                                                                         "web.activityDurationMaximum";

    public static final String advertiseAccessPermissionForOtherUrls =
                                                                         "web.advertiseAccessPermissionForOtherUrls";

    public static final String aggressiveHeapManagement              =
                                                                         "web.aggressiveHeapManagement";
    ...
    public static final String allowCookieAuthentication             =
                                                                         "web.allowCookieAuthentication";

    public static final String allowDeletingNonEmptyRepositories     =
                                                                         "web.allowDeletingNonEmptyRepositories";

    public static final String allowFlashCopyToClipboard             =
                                                                         "web.allowFlashCopyToClipboard";
    ...
    public static final String datetimestampLongFormat               =
    ...
    public static final String enableRpcAdministration               =
    ...
    public static final String enforceHttpBasicAuthentication        =
                                                                         "web.enforceHttpBasicAuthentication";
    ...
    public static final String includePersonalRepositories           =
                                                                         "web.includePersonalRepositories";
    ...
    public static final String repositoryRootGroupName               =
                                                                         "web.repositoryRootGroupName";
    ...
    public static final String showFederationRegistrations           =
                                                                         "web.showFederationRegistrations";
    ...
    public static final String showSearchTypeSelection               =
                                                                         "web.showSearchTypeSelection";
