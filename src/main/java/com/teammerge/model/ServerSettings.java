...
/**
 * Server settings represents the settings of this project server including all setting metadata such
 * as name, current value, default value, description, and directives. It is a model class for
 * serialization and presentation, but not for persistence.
 *
 */
