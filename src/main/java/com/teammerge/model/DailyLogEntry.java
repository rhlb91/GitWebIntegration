...
/**
 * Model class to simulate a push for presentation in the push log news feed for a repository that
 * does not have a Gitblit push log. Commits are grouped by date and may be additionally split by
 * ref.
 *
 */
