...
public class Constants {
	...
	/**
	 * The type of merge Gitblit will use when merging a ticket to the
	 * integration branch.
	 * <p>
	...
	public static enum MergeType {
		/**
		 * Allows a merge only if it can be fast-forward merged into the
		 * integration branch.
		 */
		FAST_FORWARD_ONLY,
		/**
		 * Uses a fast-forward merge if possible, other wise a merge commit is
		 * created.
		 */
		MERGE_IF_NECESSARY,
		// Future REBASE_IF_NECESSARY,
		/**
		 * Always merge with a merge commit, even when a fast-forward would be
		 * possible.
		 */
		MERGE_ALWAYS,
		// Future? CHERRY_PICK
	...
	public static enum AccessPermission {
		NONE("N"), EXCLUDE("X"), VIEW("V"), CLONE("R"), PUSH("RW"), CREATE(
				"RWC"), DELETE("RWD"), REWIND("RW+"), OWNER("RW+");

		public static final AccessPermission[] NEWPERMISSIONS = { EXCLUDE,
				VIEW, CLONE, PUSH, CREATE, DELETE, REWIND };

		public static final AccessPermission[] SSHPERMISSIONS = { VIEW, CLONE,
				PUSH };
	...
	public static enum AccessRestrictionType {
		...
		private static final AccessRestrictionType[] AUTH_TYPES = { PUSH,
				CLONE, VIEW };
