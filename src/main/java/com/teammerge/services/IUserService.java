...
import com.teammerge.model.TeamModel;
import com.teammerge.model.UserModel;

/**
 * Implementations of IUserService control all aspects of UserModel objects and user authentication.
 *
 * Plugins implementing this interface (which are instantiated during
 * {@link com.gitblit.manager.UserManager#start()}) can provide a default constructor or might also
 * use {@link IRuntimeManager} as a constructor argument which will be passed automatically then.
 *
 *
 */
public interface IUserService {
  ...
  /**
   * Setup the user service. This method allows custom implementations to retrieve settings from
   * gitblit.properties or the web.xml file without relying on the GitBlit static singleton.
   *
